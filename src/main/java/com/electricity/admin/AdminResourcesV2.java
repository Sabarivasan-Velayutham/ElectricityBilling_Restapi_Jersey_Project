...
public class AdminResourcesV2 {
    private UserDAO userDao;

    public AdminResourcesV2() {
    ...
    public Response getAllUsers() {
        try {
            List<User> users = userDao.getAllUsers2();
    ...
    public Response createUser(String json) {
        ...
        try {
            ...
            boolean created = userDao.createUser2(user);
    ...
    public Response updateUser(@PathParam("id") String idParam, String json) {
        try {
            ...
            ObjectMapper mapper = new ObjectMapper();
            User existingUser = userDao.getUserById2(id);
            ...
            userDao.updateUser2(existingUser);
    ...
    public Response getUserByName(@PathParam("name") String name) {
        ...
        try {
            List<User> users = userDao.getUserByName2(name);
            if (!users.isEmpty()) {
    ...
    public Response sortAllUsers(@QueryParam("by") String sortBy,
        ...
        try {
            ...
            List<User> users = userDao.getAllUsers2(sortBy, sortOrder);
            if (!users.isEmpty()) {
                return Response.status(Response.Status.OK).entity(users).build();
            } else {
